...
include(
    ":modules:features:start-idcheck-card",
    ":modules:features:start-idcheck-card:internal",
    ":modules:features:start-idcheck-card:internal-api",
    ":modules:features:start-idcheck-card:public-api",
