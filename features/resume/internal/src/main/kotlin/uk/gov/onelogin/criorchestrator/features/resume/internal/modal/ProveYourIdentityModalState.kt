...
internal class ProveYourIdentityModalState(
    ...
    override fun equals(other: Any?): Boolean = allowedToShow == (other as? ProveYourIdentityModalState)?.allowedToShow

    override fun hashCode(): Int = allowedToShow.hashCode()
}
